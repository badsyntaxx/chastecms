...
/**
 * SiteMaintenanceController Controller Class
 */
class SiteMaintenanceController extends Controller
{
    ...
    {
        $page = $this->load->model('pages')->getPage('name', 'site-maintenance');
        ...
        $view['content'] = $this->load->model('pages')->getPageContent('site-maintenance');
 
        $this->load->model('pages')->updatePageStatistics('site-maintenance');
