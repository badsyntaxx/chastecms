...
/**
 * FoomController Controller Class
 */
class FoomController extends Controller
{
    /**
     * Init method
     *
    ...
    {
        $page = $this->load->model('pages')->getPage('name', 'foom');
        ...
        $view['content'] = $this->load->model('pages')->getPageContent('foom');
 
        $this->load->model('pages')->updatePageStatistics('foom');
